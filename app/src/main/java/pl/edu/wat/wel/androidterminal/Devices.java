...
public class Devices extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BluetoothFragment fragobj = new BluetoothFragment();
    ...
    private void getWidgetReferences() {
        tvDeviceListPairedDeviceTitle = (TextView) findViewById(R.id.BT_PairedDevices_Text);
        tvDeviceListNewDeviceTitle = (TextView) findViewById(R.id.BT_NewDevices_Text);

        lvDeviceListPairedDevice = (ListView) findViewById(R.id.BT_PairedDevices_List);
        lvDeviceListNewDevice = (ListView) findViewById(R.id.BT_NewDevices_List);

        btnDeviceListScan = (Button) findViewById(R.id.BT_ScanDevices_Button);
